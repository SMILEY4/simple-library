...
export class ActionHandler {
	...
	constructor(
		...
		this.eventHandler.on(EventIds.GET_ITEMS_BY_COLLECTION, (payload) => actionGetItemsByCollection.perform(payload.collectionId, payload.includeMissingAttributes, payload.includeHiddenAttribs, payload.pageIndex, payload.pageSize));
